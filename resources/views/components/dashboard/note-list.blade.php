<div class="px-4 py-4 bg-orange-300/50 text lg basis-4/12 min-h-screen space-y-3 rounded">
    ...
    <ul id="notes-list">
        @foreach($notes as $note)
            @php
                $isNoteSelected = request('selectedNote') == $note->id;
                $isNoteInSelectedCategory = request()->has('selectedCategory') && request('selectedCategory') == $note->category_id;
                    ...
                    <button type="submit" class="text-white hover:text-red-500 focus:outline-none" aria-label="Delete note">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round"
                                  stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12
